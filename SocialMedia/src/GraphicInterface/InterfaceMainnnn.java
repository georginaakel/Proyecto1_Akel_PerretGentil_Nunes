...
public class InterfaceMainnnn extends javax.swing.JFrame {
     ...
     */
    public InterfaceMainnnn(Grafo graph, String fileRoute) {
        initComponents();
        this.util = new Util();
        this.graph = graph;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceMainnnn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceMainnnn(graph, fileRoute).setVisible(true);
            }
        });
    }
